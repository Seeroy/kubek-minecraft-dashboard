...
export const serverSettingsTranslations: TranslationDictionary = {
  ...
  modal: {
    ...
    description: "Настройки вашего сервера были сохранены успешно, но некоторые изменения вступят в силу только после перезапуска сервера",
    question: "Хотите ли вы перезапустить сервер сейчас? Вы можете перезапустить его позже из панели управления сервером",
  ...
  general: {
    ...
    performanceSettings: {
      ...
      startupArgumentsHelp: "Добавьте аргументы JVM для распределения памяти и настройки производительности"
    },
    autoRestartSettings: {
      ...
      enableAutoRestartDescription: "Автоматически перезапускать сервер при сбое",
      maxRestartAttempts: "Максимальное количество попыток перезапуска",
      maxRestartAttemptsHelp: "Количество попыток перезапуска перед прекращением"
    },
    stopConfiguration: {
      title: "Конфигурация остановки",
      description: "Как правильно остановить сервер",
      customCommand: "Пользовательская команда",
      customCommandDescription: "Отправить определенную команду для остановки сервера",
      ctrlCSignal: "Сигнал Ctrl+C",
      ctrlCSignalDescription: "Отправить сигнал прерывания (рекомендуется для большинства серверов)",
  ...
  information: {
    ...
    securitySettings: {
      ...
      whitelistDescription: "Разрешить присоединяться только игрокам из белого списка"
    }
  },
  gameplay: {
    gameRules: {
    ...
    worldSettings: {
      ...
      spawnProtectionRadiusHelp: "Блоки от спавна, где только операторы могут строить"
    }
  },
  world: {
    worldGeneration: {
  ...
  network: {
    ...
    networkConfiguration: {
      ...
      importantNoticeText: "Изменение сетевых настроек может потребовать перезапуска сервера. Убедитесь, что вы настроили брандмауэр и перенаправление портов соответственно. Если вы измените порт сервера, игроки должны подключаться с использованием нового порта"
    }
  },
  other: {
    customProperties: {
      title: "Пользовательские свойства",
      description: "Дополнительные свойства сервера, не включенные в основные категории",
    ...
    aboutServerProperties: {
      ...
      advancedConfigurationText: "Эти свойства соответствуют непосредственно файлу server.properties. Изменения, сделанные здесь, будут сохранены в этот файл при нажатии \"Сохранить изменения\". Модифицируйте эти настройки с осторожностью, поскольку они могут повлиять на стабильность сервера"
    },
    advancedSettings: {
      title: "Расширенные настройки",
      description: "Продолжайте с осторожностью",
      warning: "Предупреждение",
      warningText: "Это расширенные свойства сервера. Неправильные значения могут вызвать отказ сервера в запуске или неожиданное поведение. Модифицируйте свойства только если вы знаете, что они делают"
    }
  },
  notifications: {
    ...
    settingsSaved: "Настройки сохранены успешно. Перезапустите сервер позже, чтобы применить все изменения",
