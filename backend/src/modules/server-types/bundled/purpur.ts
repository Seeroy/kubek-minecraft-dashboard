...
export const purpur = {
  ...
  name: "Purpur",
  shortName: "Purpur",
  description: "Paper fork with extra configuration",
  game: "minecraft",
  author: {
    name: "Kubek Team",
  },
  version: "1.0.0",
  tags: ["minecraft", "java", "purpur"],
  engines: {
    kubek: ">=4.0.0",
  },
  runtime: {
  ...
  versions: {
    ...
    resolveDownload: {
      request: {
        url: "https://api.purpurmc.org/v2/purpur/{{GAME_VERSION}}",
      },
      select: "$.builds.latest",
      then: {
        url: "https://api.purpurmc.org/v2/purpur/{{GAME_VERSION}}/{{prev}}/download",
      },
    },
  },
  install: {
